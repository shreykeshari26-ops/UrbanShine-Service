...
export default function FloatingButtons() {
  return (
    <>
      ...
      {/* Sticky Mobile "Call Now" - Only visible on small screens, bottom left */}
      <a 
        href="tel:+15551234567" 
        className="fixed bottom-6 left-6 z-50 bg-primary-600 text-white p-4 rounded-full shadow-[0_4px_14px_rgba(79,168,216,0.4)] hover:-translate-y-1 transition-all flex items-center justify-center sm:hidden"
        aria-label="Call Now"
      >
